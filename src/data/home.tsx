    ...
    <Flex direction="column" align="center">
      <Flex direction={["column", "column", "row"]}>
        ...
        >
         <Avatar
      size={"2xl"}
      style={{ border: "4px solid gray", boxShadow: "0px 7px 6px rgba(0, 0, 0, 0.1)" }}
      src={UserIcon}
    />
        ...
        >
          ...
          <Box as="h3" fontSize="1xl" fontWeight="200" textAlign="left">
            My name is{" "}
...
<Box as="strong" fontWeight="600">
          ...
          <Box as="h3" fontSize="1xl" fontWeight="200" mt={5} textAlign="left">
