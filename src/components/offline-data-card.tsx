...
import { AiOutlineStar, AiOutlineShareAlt, AiOutlineFileDone } from "react-icons/ai";
        ...
        >
          ...
          <VStack py={2} px={[2, 4]} spacing={1} align="start" w="100%">
            <Flex justifyContent={"space-between"} width="100%">
              <Tooltip hasArrow label="Verify at" placement="top">
                <HStack>
                  <Icon as={AiOutlineFileDone} boxSize="0.9em" mt={"1px"} />
