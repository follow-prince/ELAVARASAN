...
import { FaGithub, FaInstagram, FaLinkedin, FaIdCard } from "react-icons/fa";
...
const webLinks = [
  ...
  { name: "Certificates", path: "/open-source" },
...
export default function TopNav() {
  ...
  <IconButton
              as={Link}
              href={"https://drive.google.com/file/d/1Owat4YK7wC0gUrz4JyTEuncudH5Y0_f7/view?usp=share_link"}
              size={"md"}
              icon={<FaIdCard />}
              aria-label={"Resume"}
              bg={useColorModeValue("white", "gray.700")}
